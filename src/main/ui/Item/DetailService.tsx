...
// @ts-ignore
import { Treatments } from './DetailService.tsx';
...
const DetailService = () => {
  ...
  const [cartItems] = useState<Treatments[]>([]);
  ...
  const {item} = route.params as {item: Treatments};
  console.log(item);
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        />
        <Text style={styles.tv2}>{item.treatment_name}</Text>
